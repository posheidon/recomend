module Recommendation
  ...
  class RecommendBase
    ...
    # Returns active user's prediction for the specified product
    # Calls rating_for method of the child class to compute the rating
    def predict_rating_for(active_user, product)
      # If active user is already rated that product, return the rating
      return active_user.rating_for product.id if active_user.has_product? product.id
